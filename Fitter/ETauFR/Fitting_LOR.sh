...
###TEST TO AUTOMAT
#templateFittingETauFR zee_fr_m_vis_eta0to1.448_et-UL2017.inputs.root VLoose | tee ./zee_fr_m_vis_eta0to1.448_et-UL2017.inputs.txt
#text2workspace.py -m 90 -P TauFW.Fitter.ETauFR.zttmodels:ztt_eff --PO "eff=0.0491043" ./input/UL2017/ETauFR/VLoose_eta1.56to2.3.txt -o  ./WorkSpace/UL2017/WorkSpaceVLooseLt1p460.root
text2workspace.py -m 90 -P HiggsAnalysis.ETauFR.zttmodels:ztt_eff --PO "0.3527870589" ./input/UL2017/ETauFR/VLoose_eta0to1.46.txt -o  ./WorkSpace/UL2017/WorkSpaceVLooseLt1p46.root
#text2workspace.py -m 90 -P HiggsAnalysis.ETauFR.zttmodels:ztt_eff --PO "0.00604407805199" ./input/UL2017/ETauFR/VLoose_eta1.56to2.3.txt -o  ./WorkSpace/UL2017/WorkSpaceVLooseLt2p300.root
combine -m 90  -M FitDiagnostics --robustFit=1 --expectSignal=1.0 --rMin=0.7 --rMax=1.5 --cminFallbackAlgo "Minuit2,0:1" -n "" ./WorkSpace/UL2017/WorkSpaceVLooseLt1p46.root | tee ./$OUTDIR/ScaleVLooseLt1p46.txt
#combine -m 90  -M FitDiagnostics --robustFit=1 --expectSignal=1.0 --rMin=0.7 --rMax=1.5 --cminFallbackAlgo "Minuit2,0:1" -n "" ./WorkSpace/UL2017/WorkSpaceVLooseLt2p300.root | tee ./$OUTDIR/ScaleVLooseLt2p300.txt
#combine -m 90  -M FitDiagnostics --robustFit=0 --expectSignal=1.0 --rMin=0.0 --rMax=3.0 --cminFallbackAlgo "Minuit2,0:1" -n "" ./WorkSpace/UL2017/WorkSpaceVLooseLt1p46.root | tee ./$OUTDIR/ScaleVLooseLt1p46.txt
#combine -m 90  -M FitDiagnostics --robustFit=1 --expectSignal=1.0 --rMin=0.0 --rMax=4.0 --cminFallbackAlgo "Minuit2,0:1" -n "" ./WorkSpace/UL2017/WorkSpaceVLooseLt2p300.root | tee ./$OUTDIR/ScaleVLooseLt2p300.txt
...
#./compare.py -a fitDiagnostics.root | tee ./$OUTDIR/VLooseLt1p46Pull.txt
PostFitShapesFromWorkspace -o ./PostFitShape/UL2017/ETauFRVLooseLt1p46_PostFitShape.root -m 90 -f fitDiagnostics.root:fit_s --postfit --sampling --print -d ./input/UL2017/ETauFR/VLoose_eta0to1.46.txt -w ./WorkSpace/UL2017/WorkSpaceVLooseLt1p46.root
#PostFitShapesFromWorkspace -o ./PostFitShape/UL2017/ETauFRVLooseLt2p300_PostFitShape.root -m 90 -f fitDiagnostics.root:fit_s --postfit --sampling --print -d ./input/UL2017/ETauFR/VLoose_eta1.56to2.3.txt -w ./WorkSpace/UL2017/WorkSpaceVLooseLt2p300.root
